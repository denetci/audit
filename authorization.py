...
MODULES = {"dashboard": "Faaliyet Paneli", "audits": "Denetimler", "approvals": "Olurlar", "personnel": "Personel", "leaves": "Personel İzinleri", "duties": "Görev Durumu", "budget": "Bütçe İşlemleri", "stock": "Stok İşlemleri", "membership": "Aidat Takibi", "overtime": "İşçi Puantajı", "monitoring": "İzleme Faaliyetleri", "reports": "Rapor Arşivi"}
COLLECTION_MODULE = {"approvals": "approvals", "leaves": "leaves", "leaveRights": "leaves", "dutyRecords": "duties", "budgetItems": "budget", "budgetExpenses": "budget", "stockItems": "stock", "stockCashRecords": "stock", "membershipRecords": "membership", "membershipTemplates": "membership", "overtimeRecords": "overtime", "overtimeWorkers": "overtime", "personnelRecords": "personnel"}
...
def project_record(user, collection, record):
    ...
    if collection == "personnelRecords" and not access(user, "personnel"):
        if any(access(user, m) for m in ("leaves", "duties", "stock", "membership", "overtime")):
